        ...
        if (slideConfig.title == '' && slideConfig.description == '') {
          ...
          switch (slideConfig.title) {
            ...
            case "3DOF VTOL Simulation":
              slideTitle.innerHTML = '<center><h3>3DOF VTOL Simulation</h3></center> <p style="color: #575757">For my final project for MAE 4780: Feedback Controls, I crated a 3DOF simulation for a thrust vectoring VTOL Rocket in Simulink and designed a full-state feedback controller and Extended Kalman Filter for control and estimation. You can find my report <a href="assets/Final Report.pdf" download="MAE 4780 Final Report.pdf"> here </p>';
              break;
            case "VTOL Rocket":
